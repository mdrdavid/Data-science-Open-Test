...
# ===============================
Telco_Customer_Churn <- read_csv("DS Assignments/Telco-Customer-Churn.csv")
...
cat("4. Develop offers for month-to-month contracts\n")
cat("5. Support electronic check users\n")
cat("6. Loyalty programs for long-tenure customers\n")
